...
```bash
curl -sSL https://raw.githubusercontent.com/YOUR_REPO/main/scripts/install-linux.sh | sudo bash
```
...
wget https://github.com/YOUR_REPO/releases/latest/download/argon-watch-go-linux
